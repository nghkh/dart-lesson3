void main(List<String> args) {
  ...
  */
  ...
  List<int>? arrsToInt = arrs.map((e) => int.parse(e ?? '10')).toList(); 
  //giá trị e là null không chuyển được sang int, 
  //thêm Null-aware khởi tạo giá trị khác là "10"
  ...
  */
  ...
  map["fourth"] = [
    ...arrs.map((e) => int.parse(e ?? '10')).where((e) => e % 2 == 1), // tương tự dòng 18
    ...arrs.where((e) => e == null),
    ...sMap[3]?? [].sublist(0,2) // sublist chỉ hoạt động khi sMap[3] != null
  ];